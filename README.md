...
### 1️⃣ 邀請機器人到你的 Discord 伺服器

點擊下方連結，將機器人加入你的 Discord 伺服器：

[![Invite Bot](https://img.shields.io/badge/Invite-Bot-5865F2?logo=discord&logoColor=white)](https://discord.com/oauth2/authorize?client_id=1421009491201097748)

#### 📌 前置條件
- 你必須擁有該伺服器的「管理伺服器（Manage Server）」權限

#### 📥 邀請步驟
1. 點擊上方邀請連結
2. 登入你的 Discord 帳號（若尚未登入）
3. 在「新增至伺服器」下拉選單中選擇目標伺服器
4. 點擊「繼續」
5. 檢查並確認機器人所需權限
6. 點擊「授權」
7. 完成人機驗證（CAPTCHA）
